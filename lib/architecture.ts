...
export const adminSections = [
  ...
  { href: '/admin/access', label: 'Access & RBAC', icon: 'ShieldCheck' },
  { href: '/admin/hotels', label: 'Hotel Master', icon: 'Hotel' },
  { href: '/admin/distribution', label: 'Distribution', icon: 'Network' },
